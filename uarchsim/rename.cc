...
void pipeline_t::rename2() {
   ...
   int checkpoints_needed = 0;
   int dest_reg_needed = 0;
   ...
   if(REN->stall_branch(checkpoints_needed)) return;
   if(REN->stall_reg(dest_reg_needed)) return;
